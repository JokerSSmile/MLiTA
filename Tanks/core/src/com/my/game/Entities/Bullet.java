...
public class Bullet extends Entity{
    ...
    public Bullet(ResourceManager resources, Vector2 startPos, Vector2 velocity, boolean isPlayers){
    ...
    private void createAnimations(){
        ...
        TextureRegion[] destroy1d = com.my.game.ResourceStorage.Animation.getFramesArray1D(destroyTexture, 4, 4);
    ...
    public void render(SpriteBatch batch){
        if (liveState == aliveState.ALIVE) {
            batch.draw(animation.getKeyFrame(stateTime, true), position.x, position.y, 32, 32);
        }
        else{
            batch.draw(animation.getKeyFrame(stateTime, true), position.x - 16, position.y - 16);
        }
    }
