...
public class EndGameState extends Screen {
    ...
    private static final Vector2 MENU_BTN_POS = new Vector2(-150, -150);
    private static final Vector2 TEXT_SHIFT = new Vector2(-300, 200);
    ...
    public EndGameState(GameScreenManager gsm, ResourceManager resources, boolean isWin){
        ...
        /*playerTexture = isWin ? resources.getTexture(ResourceManager.goodFinal) :
                resources.getTexture(ResourceManager.badFinal);*/
